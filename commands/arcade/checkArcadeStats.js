...
export default {
 ...
 data: new SlashCommandBuilder()
  .setName('arcadestats')
  .setDescription('Replies with your arcade stats! Api key is in the .env file so change that lol!')
    ...
    axios({
     ...
     .then(() => {
      ...
      const arcadeStats = new EmbedBuilder()
       ...
       .addFields(
        {
         name: 'Total number of sessions completed: ',
         value: sessionCount.toString() + ' sessions',
        },
